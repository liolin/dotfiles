...
#+begin_src conf :tangle ~/.config/sway/config
  ...
  set $locker swaylock -k -l -i ~/Pictures/wall_anime_8K.png
  ...
  output * bg ~/Pictures/wallpaper/liolin_wallpaper_black.jpg fill
  output $internal_mon resolution 1920x1080 position 0,0
